...
1. Entrá a github.com con la misma cuenta de siempre.
2. Creá un repo nuevo llamado `CARP_historicos_martin_garcia`.
3. Con "Add file → Create new file", creá:
   - `descubrir_zips.py` — pegá el contenido tal cual.
   - `.github/workflows/descubrir.yml` — pegá el contenido tal cual.
4. Pestaña **Actions** → "Descubrir ZIPs historicos CARP" →
   **Run workflow**.
5. Cuando termine, avisame y reviso el log (o lo que quedó en
